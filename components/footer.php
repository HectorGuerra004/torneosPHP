...
<footer class="w-100 mt-4 footer">
    <section class="container">
        <div class="row border-bottom">
            <div class="col-md-6 p-4">
                <figure class="border-bottom px-2 figure-footer">
                    <h2 style="color: white;">GameOn Fc</h2>
                </figure>
                <div class="d-flex info-company">
                    <div class="info-item">
                        <i><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="30px"
                                height="30px">
                    ...
                    <div class="info-item">
                        ...
                        <span><a target="_blank" href="https://wa.me/?text=" class="a_footer">+58 00000000000</a></span>
                    </div>
                    <div class="info-item">
                        <i>
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="30px"
                        ...
                        <span><a href="mailto:" class="a_footer">GameOnFc@gmail.com</a></span>

                    </div>
                </div>
            </div>
            <div class="col-md-3 p-4">
                <div class="d-flex border-bottom px-2 h4-footer">
                    <h4 class="">Enlaces &Uacute;tiles</h4>
                </div>
                <div class="link-footer">
                    <a href="index.php" class="a_footer"><span><b>Inicio</b></span></a>
                    <a href="registrarse.php" class="a_footer"><span><b>Registrate</b></span></a>
                    <a href="iniciarSesion.php" class="a_footer"><span><b>Iniciar Sesion</b></span></a>
                </div>
            </div>
            <div class="col-md-3 p-4">
                <div class="d-flex border-bottom px-2 h4-footer">
                ...
                <div class="link-footer">
                    <a href="" class="a_footer"><span><b>Bronce</b></span></a>
                </div>
                <div class="link-footer">
                    <a href="" class="a_footer"><span><b>Plata</b></span></a>
                </div>
                <div class="link-footer">
                    <a href="" class="a_footer"><span><b>Oro</b></span></a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 p-4">
                <div class="policy-footer">
                    ...
                    <span>|</span>
                    <span><a href="" class="a_footer">T&eacute;rminos y condiciones</a></span>
                    <span>|</span>
                    <span><a href="" class="a_footer">Pol&iacute;ticas de privacidad</a></span>
                </div>
            </div>
            <div class="col-md-6 p-4">
                <div class="d-flex social-footer">
                    <a href=""><svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffffff" width="20" height="20">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                    ...
                    <a href=""><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20"
                            height="20">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                    ...
                    <a href="">
                        <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" width="20"
                            height="20">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
